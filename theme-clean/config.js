(() => {
  const primary = { deep: "#2563EB", strong: "#5182EF", base: "#92B1F5", soft: "#B1C7F8", pale: "#CFDDFB", mist: "#E9EFFD" };
  const secondary = { deep: "#6D5BD0", strong: "#8A7CD9", base: "#B6ADE8", soft: "#CAC4EE", pale: "#DFDBF5", mist: "#F0EFFA" };
  const tertiary = { deep: "#0891B2", strong: "#39A7C1", base: "#84C8D9", soft: "#A6D7E3", pale: "#C9E7EE", mist: "#E6F4F7" };
  const warning = { deep: "#E6A700", strong: "#EBB933", base: "#F3D380", soft: "#F6DFA3", pale: "#FAECC7", mist: "#FDF6E5" };
  const success = { deep: "#178A45", strong: "#45A16A", base: "#8BC5A2", soft: "#ABD5BC", pale: "#CCE5D6", mist: "#E8F3EC" };
  const danger = { deep: "#CF3340", strong: "#D95C66", base: "#E799A0", soft: "#EEB6BA", pale: "#F4D2D5", mist: "#FAEBEC" };
  const neutral = { deep: "#46505C", strong: "#6B737D", base: "#A3A8AE", soft: "#BCC0C4", pale: "#D6D9DB", mist: "#EDEEEF", white: "#FFFFFF" };
