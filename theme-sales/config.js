(() => {
  const primary = { deep: "#0D65D9", strong: "#3D84E1", base: "#86B2EC", soft: "#A8C8F1", pale: "#CADDF7", mist: "#E7F0FB" };
  const secondary = { deep: "#7047C7", strong: "#8D6CD2", base: "#B8A3E3", soft: "#CCBDEB", pale: "#E0D7F3", mist: "#F1EDF9" };
  const tertiary = { deep: "#0095B8", strong: "#33AAC6", base: "#80CADC", soft: "#A3D9E5", pale: "#C7E8EF", mist: "#E5F4F8" };
  const warning = { deep: "#F5A800", strong: "#F7B933", base: "#FAD480", soft: "#FBE0A3", pale: "#FDECC7", mist: "#FEF6E5" };
  const success = { deep: "#07945A", strong: "#39A97B", base: "#83CAAD", soft: "#A6D8C4", pale: "#C8E7DB", mist: "#E6F4EE" };
  const danger = { deep: "#D83A45", strong: "#E0616A", base: "#EC9DA2", soft: "#F1B8BC", pale: "#F6D4D6", mist: "#FBEBEC" };
  const neutral = { deep: "#3E4652", strong: "#656B75", base: "#9FA3A9", soft: "#BABCC1", pale: "#D5D6D9", mist: "#ECEDEE", white: "#FFFFFF" };
